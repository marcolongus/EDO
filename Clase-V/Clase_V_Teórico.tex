...
\begin{document}
	...
	En la Clase IV estudiamos las ecuaciones lineales de primer orden y el método del factor integrante. En esta clase estudiaremos ecuaciones exactas y ecuaciones de Bernoulli.

	El factor integrante reaparecerá como una función que puede transformar ciertas ecuaciones no exactas en exactas. Luego, para resolver una ecuación de Bernoulli, introduciremos una nueva variable dependiente que satisfaga una ecuación lineal. Ambos temas reutilizan herramientas de la Clase IV en contextos diferentes.
