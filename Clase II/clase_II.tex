...
Frente a un problema de este tipo aparecen, al menos, tres preguntas diferentes:
	...
	La idea que organiza esta clase es estudiar primero cuál es la máxima información que podemos extraer de una ecuación diferencial \emph{antes de resolverla}. Analizaremos su dominio, la existencia y unicidad de las soluciones, sus posibles formas de representación y los campos de direcciones. El estudio de las ecuaciones autónomas y la estabilidad, junto con los métodos de integración directa y separación de variables, se desarrolla en el material suplementario de esta clase.
