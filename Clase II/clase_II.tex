...
mientras que el signo de $y_0$ selecciona la rama correspondiente.
	...
	\begin{quote}
		\textbf{Idea central.} La constante de integración describe una familia de curvas. Una relación implícita puede contener varias ramas, y cada rama debe analizarse como una función junto con su intervalo de definición.
	\end{quote}
